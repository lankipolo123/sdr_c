...
gcc -std=c99 -Wall -Wextra -Wpedantic -Werror -mwindows -Os -s ^
    ...
    -o digital_noise_config_multi.exe src\main.c src\connection.c src\channels.c src\protocol.c src\serial_port.c src\app_res.o ^
    -ladvapi32 -lgdi32 -luser32 -lcomctl32
